...
SET PATH=%PATH%;C:\Program Files\edb\as16\bin
```
...
-D /var/lib/edb/as16/data -U enterprisedb
-b /usr/edb/as15/bin -B /usr/edb/as16/bin -p 5444 -P 5445 --check
```
...
-D "C:\Program Files\edb\as16\data" -U enterprisedb
-b "C:\Program Files\PostgresPlus\15AS\bin"
-B "C:\Program Files\edb\as16\bin" -p 5444 -P 5445 --check
```
...
pg_upgrade -d /var/lib/edb/as15/data
-D /var/lib/edb/as16/data -U enterprisedb
-b /usr/edb/as15/bin -B /usr/edb/as16/bin -p 5444 -P 5445
```
...
-D "C:\Program Files\edb\as16\data" -U enterprisedb
-b "C:\Program Files\PostgresPlus\15AS\bin"
-B "C:\Program Files\edb\as16\bin" -p 5444 -P 5445
```

`pg_upgrade` displays the progress of the upgrade onscreen:

```shell
$ pg_upgrade -d /var/lib/edb/as15/data -D /var/lib/edb/as16/data -U
enterprisedb -b /usr/edb/as15/bin -B /usr/edb/as16/bin -p 5444 -P 5445
