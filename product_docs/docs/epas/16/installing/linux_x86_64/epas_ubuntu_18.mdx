...
redirects:
  - /epas/16/epas_inst_linux/installing_epas_using_edb_repository/x86_amd64/epas_ubuntu18_x86
  - /epas/16/epas_inst_linux/installing_epas_using_edb_repository/x86/epas_ubuntu18_x86
---
